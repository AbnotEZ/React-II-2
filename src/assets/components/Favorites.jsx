...
function Favorites() {
  ...
  return (
    <>
      <div className="container flex flex-wrap justify-center items-center bg-fixed">Favorites</div>
        ...
        {data.map ((item,i) =>(
          ...
          >
            <div className="p-1 m-1 bg-amber-200 justify-center rounded-x1 trasnform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2x">
              <button onClick={() => noMeGusta(item.name)} className="text-gray-50">♥</button>
            </div>
            <img
